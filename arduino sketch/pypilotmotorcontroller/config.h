...
#define RUDDER_MIN 0 // The minimum value at which RUDDER_MIN flag is being set
#define RUDDER_MAX 65535 // The maximum value at which RUDDER_MAX flag is being set
#define RUDDER_MIN_ADC 0 // Your actual minimum sensor value
#define RUDDER_MAX_ADC 65535 // Your actual maximum sensor value. These two must be configured to your setup to work properly
...
#define SPEEDUP_SLEW_RATE 20 // Slew rate when accelerating the motor / pump / linear actuator (15)
#define SLOWDOWN_SLEW_RATE 30 // Slew rate when decelerating the motor / pump / linear actuator (30)
...
#define THERMISTORNOMINAL 4700 // 4,7k thermistor geändert auf 4700
// temp. for nominal resistance (almost always 25 C)
#define TEMPERATURENOMINAL 25
// The beta coefficient of the thermistor (usually 3000-4000)
#define BCOEFFICIENT 3950
// the value of the 'other' resistor
#define SERIESRESISTOR 22000 // 22k resistor GEÄNDERT!! vorher war 4700 und 4,7k
...
// *************************************************************************************************** //
// Maximum input Current on the supply pin
#define A_MAX 4300
// Voltage divider resistor 1
#define R1_2 47000.0f
// Voltage divider resistor 2
#define R2_2 120000.0f
// Constant calculated from resistor values for simplified voltage calculation
